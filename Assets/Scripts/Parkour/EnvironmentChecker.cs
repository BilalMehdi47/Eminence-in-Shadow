...
//         if (ledgeHeight > ledgeRayHeightThreshold)
//         {
//             var surfaceRaycastOrigin = transform.position + movementDirection * 0.1f;
//             if (!Physics.Raycast(surfaceRaycastOrigin, movementDirection, 0.5f, obstacleLayer))
//             {
//                 ledgeInfo.angle = Vector3.Angle(transform.forward, hit.normal);
//                 ledgeInfo.height = ledgeHeight;
//                 ledgeInfo.surfaceHit = hit;
//                 return true;
//             }
//         }
//     }
